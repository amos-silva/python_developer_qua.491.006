...
while True:
    ...
    try:
        ...
        if imc <=18.5:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta ABAIXO do peso")    # :. 2f  casas decimais no numero

        elif imc >=18.5 and imc <25:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta no peso IDEAL")

        elif imc >=25 and imc <30:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta ACIMA do peso")

        elif imc >=30 and imc <35:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta OBESO")

        elif imc >=35 and imc <40:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta OBESO - Nivel 2")

        elif imc >=40:
            print(f"o valor do IMC é: {imc:.0f} - Voce esta com OBESIDADE MORBITA")
